...
| Family Summary | List families with species counts | [`pm_list_families()`](https://paulesantos.github.io/perumammals/dev/reference/pm_list_families.md) |
| Family Filter | Filter by specific family | `pm_species(family = "Cricetidae")` |
| Endemic Analysis | List endemic species statistics | [`pm_list_endemic()`](https://paulesantos.github.io/perumammals/dev/reference/pm_list_endemic.md) |
