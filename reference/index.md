...
- [`found_in_peru()`](https://paulesantos.github.io/perumammals/reference/found_in_peru.md)
  [`pm_found_in_peru()`](https://paulesantos.github.io/perumammals/reference/found_in_peru.md)
...
- [`get_common_names_peru()`](https://paulesantos.github.io/perumammals/reference/get_common_names_peru.md)
  [`pm_common_names()`](https://paulesantos.github.io/perumammals/reference/get_common_names_peru.md)
  : Get taxonomic and common name information for Peru mammals

- [`is_endemic_peru()`](https://paulesantos.github.io/perumammals/reference/is_endemic_peru.md)
  [`pm_is_endemic()`](https://paulesantos.github.io/perumammals/reference/is_endemic_peru.md)
  : Check if species are endemic to Peru

- [`is_peru_mammal()`](https://paulesantos.github.io/perumammals/reference/is_peru_mammal.md)
  [`pm_is_mammal()`](https://paulesantos.github.io/perumammals/reference/is_peru_mammal.md)
  : Check if species are Peru mammals

- [`match_quality_peru()`](https://paulesantos.github.io/perumammals/reference/match_quality_peru.md)
  [`pm_match_quality()`](https://paulesantos.github.io/perumammals/reference/match_quality_peru.md)
...
- [`pm_backbone_info()`](https://paulesantos.github.io/perumammals/reference/pm_backbone_info.md)
...
- [`pm_endemics()`](https://paulesantos.github.io/perumammals/reference/pm_endemics.md)
...
- [`pm_list_genera()`](https://paulesantos.github.io/perumammals/reference/pm_list_genera.md)
  : List genera in the Peruvian mammal backbone

- [`pm_list_orders()`](https://paulesantos.github.io/perumammals/reference/pm_list_orders.md)
...
- [`validate_peru_mammals()`](https://paulesantos.github.io/perumammals/reference/validate_peru_mammals.md)
  [`pm_match()`](https://paulesantos.github.io/perumammals/reference/validate_peru_mammals.md)
