...
This outlines how to propose a change to perumammals. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("PaulESantos/perumammals", fork = TRUE)`.
...
Please note that the perumammals project is released with a [Contributor
Code of
Conduct](https://paulesantos.github.io/perumammals/dev/CODE_OF_CONDUCT.md).
